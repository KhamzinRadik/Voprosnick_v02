///////////////////////////////////////////////////////////////////////////////
//                                                                           //
//                   LibXL .NET wrapper version 4.4.1                        //
//                                                                           //
...
namespace libxl
{
    abstract public class Book 
    {
        ...
        {
            return xlBookRemoveVBA(handle) > 0;
        }

        public bool xlBookRemovePrinterSettings()
        {
            return xlBookRemovePrinterSettings(handle) > 0;
        }
        ...
        [DllImport("libxl.dll", CharSet = CharSet.Unicode, CallingConvention = CallingConvention.Cdecl)]
        private static extern int xlBookRemoveVBA(IntPtr handle);

        [DllImport("libxl.dll", CharSet = CharSet.Unicode, CallingConvention = CallingConvention.Cdecl)]
        private static extern int xlBookRemovePrinterSettings(IntPtr handle);
